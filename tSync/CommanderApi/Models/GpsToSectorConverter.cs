...
namespace tSync.CommanderApi.Models
{
    ...
    {
        private readonly GpsItemContract _topLeft;     // Top-left corner of the sector
        private readonly GpsItemContract _bottomRight; // Bottom-right corner of the sector
        private readonly ICoordinateTransformation _gpsToUtm;
        private readonly int _utmZone;

        public GpsToSectorConverter(GpsItemContract topLeft, GpsItemContract bottomRight)
        {
            _topLeft = topLeft;
